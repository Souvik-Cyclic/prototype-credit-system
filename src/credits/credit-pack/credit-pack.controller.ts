import { Controller, Post, Res, Body, HttpStatus, Get, UseGuards, Param, Delete, Put, Query } from '@nestjs/common';
...
export class CreditPackController {
  ...
  @Post()
  @ApiOperation({ summary: 'Create a credit pack', description: 'Create a credit pack' })
  ...
  @Get('all')
  @ApiOperation({ summary: 'Get all credit packs', description: 'Get all credit packs, filtered by active status if provided' })
  ...
  async findAll(
    ...
    try{
      ...
      return OK(res, 'Credit packs retrieved successfully', creditPacks, HttpStatus.OK);
    } catch (error) {
      return errorHandler(error, res);
    }
  }
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Get a credit pack', description: 'Get a credit pack' })
  ...
  async findOne(
    ...
    try{
      ...
      return OK(res, 'Credit pack retrieved successfully', creditPack, HttpStatus.OK);
    } catch (error) {
      return errorHandler(error, res);
    }
  }
  ...
  @Put(":id")
  @ApiOperation({ summary: 'Update a credit pack', description: 'Update a credit pack' })
  ...
  async update(
    ...
    try{
      const updatedCreditPack = await this.creditPackService.update(id, updateCreditPackDto);
      return OK(res, 'Credit pack updated successfully', updatedCreditPack, HttpStatus.OK);
    } catch (error) {
      return errorHandler(error, res);
    }
  }
  ...
  @Delete(':id')
  @ApiOperation({ summary: 'Delete a credit pack', description: 'Delete a credit pack' })
  ...
  async remove(
    ...
    try{
      ...
      return OK(res, 'Credit pack deleted successfully', creditPack, HttpStatus.OK);
    } catch (error) {
      return errorHandler(error, res);
    }
  }
